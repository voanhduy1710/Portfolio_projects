...
function getAccessToken() {
  ...
  const payload = { 
    app_id: '####################', // EDIT app_id when needed
    app_secret: '################################' // EDIT app_secret when needed
  };
    try {
...
function fetchLarkData() { 
  ...
  const APP_TOKEN = "################################"; // EDIT APP_TOKEN when needed
  const TABLE_ID = "################"; // EDIT TABLE_ID when needed
